...
class AccountControllerTest {
    ...
    class Balance {
        @Test
        void get_account_balance_should_return_http_status_not_found_404_if_client_not_found()
                throws Exception
        {
            // given
            Long clientId = 999L;

            when(balanceCommand.getBalance(any())).thenThrow(ClientNotFoundException.class);
        ...
        @Test
        void get_account_balance_should_return_http_status_ok_200_if_get_balance_succeed()
                throws Exception
        {
            // given
            Long clientId = 1L;
            ...
            when(balanceCommand.getBalance(any())).thenReturn(balance);
    ...
    class Deposit {
        @Test
        void deposit_should_return_http_status_not_found_404_if_client_not_found()
                throws Exception
        {
            // given
            Long clientId = 999L;
            ...
            when(depositCommand.doDeposit(clientId,depositAmount)).thenThrow(ClientNotFoundException.class);
        ...
        @Test
        void deposit_should_return_http_status_bad_request_400_if_param_client_id_is_below_min()
                throws Exception
        {
            // given
            Long clientId = 0L;
        ...
        @Test
        void deposit_should_return_http_status_bad_request_400_if_param_deposit_is_below_min()
                throws Exception
        {
            // given
            Long clientId = 1L;
        ...
        @Test
        void deposit_should_return_http_status_bad_request_400_if_param_deposit_is_above_max()
                throws Exception
        {
            // given
            Long clientId = 1L;
        ...
        @Test
        void deposit_should_return_http_status_ok_200_if_deposit_succeed()
                throws Exception
        {
            // given
            Long clientId = 1L;
            ...
            when(depositCommand.doDeposit(clientId,deposit)).thenReturn(balance);
    ...
    class Withdraw {
        @Test
        void withdraw_should_return_http_status_not_found_404_if_client_is_not_found()
                throws Exception
        {
            // given
            Long clientId = 999L;
            ...
            when(withdrawCommand.doWithdraw(clientId,withdraw)).thenThrow(ClientNotFoundException.class);
        ...
        @Test
        void withdraw_should_return_http_status_bad_request_400_if_param_clientId_is_below_min()
                throws Exception
        {
            // given
            Long clientId = 0L;
        ...
        @Test
        void withdraw_should_return_http_status_bad_request_400_if_param_withdraw_is_below_min()
                throws Exception
        {
            // given
            Long clientId = 1L;
        ...
        @Test
        void withdraw_should_return_http_status_bad_request_400_if_param_withdraw_is_above_max()
                throws Exception
        {
            // given
            Long clientId = 1L;
                ...
                throws Exception
        {
            ...
            Long clientId = 1L;
            BigDecimal withdraw = BigDecimal.valueOf(20.00);
            when(withdrawCommand.doWithdraw(clientId,withdraw)).thenThrow(InsufficientFundsException.class);
        ...
        @Test
        void withdraw_should_return_http_status_ok_200_if_withdraw_succeed()
                throws Exception
        {
            // given
            Long clientId = 1L;
            ...
            when(withdrawCommand.doWithdraw(any(),any(BigDecimal.class))).thenReturn(balance);
